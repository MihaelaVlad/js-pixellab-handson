...
console.warn(
  `
  Afiseaza suprafata totala a unor dreptunghiuri de 5 pe
  3, respectiv 3 pe 2. Foloseste variabile.
  `,
);
...
console.warn(
  `
  Calculeaza intr-o variabila numita squareSurface aria
...
console.warn(
  `
  Folosind functia calculateRectangleArea() afiseaza suprafata unui
  dreptunghi de 12 pe 9
`,
);
...
const rectangleSurfaceOne = calculateRectangleArea(15, 31);
const rectangleSurfaceTwo = calculateRectangleArea(8, 9);
const rectangleSurfaceThree = calculateRectangleArea(10, 5);
console.log(rectangleSurfaceOne + rectangleSurfaceTwo + rectangleSurfaceThree);
